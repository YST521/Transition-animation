...
-(void)setBLKbar{
   ...
   [myBar addSubview:label];
    ...
    imageV.frame = CGRectMake(0, 0, myBar.frame.size.width, myBar.frame.size.height);
      [imageV addLayoutAttributes:finalLayoutAttributes forProgress:0.0];
  [imageV addLayoutAttributes:finalLayoutAttributes forProgress:1.0];
    [myBar addSubview:imageV];
